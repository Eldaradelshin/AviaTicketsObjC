...
#define API_TOKEN @"1c409d85bc2c69e5352e3f7a47974fb5"
...
- (void)ticketsWithRequest:(SearchRequest)request withCompletion:(void (^)(NSArray *))completion
{
...
- (void)mapPricesFor:(City *)origin withCompletion:(void (^)(NSArray *))completion
{
    static BOOL isLoading;
    if (isLoading) { return; }
    isLoading = YES;
    [self load:[NSString stringWithFormat:@"%@%@", API_URL_MAP_PRICE, origin.code]
withCompletion:^(id _Nullable result) {
